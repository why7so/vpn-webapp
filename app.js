(function () {
  ...
  // viewBox подогнан под фактические границы фигуры, а не оставлен 0 0 24 24.
  // Браузер центрирует холст, а не рисунок: у карандаша тело занимает
  // x от 3 до 22 и y от 2 до 21, то есть центр фигуры (12.5, 11.5) не
  // совпадает с центром холста (12, 12) — значок сидел в круге криво.
  // Квадрат со стороной 20 вокруг центра фигуры это исправляет, и оба
  // значка при этом остаются одного масштаба.
  const ICON_PENCIL =
    '<svg viewBox="2.5 1.5 20 20" fill="currentColor">' +
  ...
  // То же для корзины: её фигура занимает x от 4 до 20 и y от 3 до 22,
  // центр (12, 12.5) — она сидела ниже середины круга.
  const ICON_TRASH =
    '<svg viewBox="2 2.5 20 20" fill="currentColor">' +
